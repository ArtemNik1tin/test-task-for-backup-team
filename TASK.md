# Тестовое задание: клиент-серверное приложение для управления DNS-серверами
...
- Пишем на Go
- Управление DNS серверами нужно реализовать через файл /etc/resolv.conf. Считаем, что никто другой на системе в него не пишет, кроме нашего приложения
...
- Сервер предоставляет REST или gRPC API на выбор. Документацию по API генерить не требуется
- Напиши несколько юнит-тестов на функционал управления DNS в серверном приложении
- Упаковывать в докер и подобное не требуется
